...
describe("String#numbers_to_words") do
  ...
  it("if input is 30, return thirty") do
  ...
  it("if input is 40925, return forty thousand nine hundred twenty five") do
    expect("40925".numbers_to_words()).to(eq("forty thousand nine hundred twenty five"))
  end
  it("if input is 919, return nine hundred nineteen") do
    expect("919".numbers_to_words()).to(eq("nine hundred nineteen"))
  end
  # it("if input is 405919, return four hundred five thousand nine hundred nineteen") do
  #   expect("405919".numbers_to_words()).to(eq("four hundred five thousand nine hundred nineteen"))
  # end
end
